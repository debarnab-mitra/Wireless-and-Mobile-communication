...
I_demod = zeros(n_points,1) + 1;
Q_demod = zeros(n_points,1) + 1;
...
x1 = mapIQtoN(I_demod_1(i),Q_demod_1(i));
x2 = mapIQtoN(I_demod_2(i),Q_demod_2(i));
x3 = mapIQtoN(I_demod_3(i),Q_demod_3(i));
...
xtitle( 'Pe vs Tx SNR, time diversity', 'Tx SNR', 'Pe')
